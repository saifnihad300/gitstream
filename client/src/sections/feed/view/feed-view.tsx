import { useState, useCallback } from 'react'; // ✅ 1. Built-in React hooks

// ✅ 2. Third-party libraries (MUI components)
...
import FeedCards from 'src/sections/products/product-card';
import { ProductItem } from '../feed-item';
